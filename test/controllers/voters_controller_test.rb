...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { first_name: @voter.first_name, last_name: @voter.last_name, registered: @voter.registered } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { first_name: @voter.first_name, last_name: @voter.last_name, registered: @voter.registered } }
